...
// GetNewChatMessageCappingInfo gets the current new chat message capping state of the account,
// i.e. how many new chats the account may still start in the current cycle.
//
// This is only meaningful for business accounts in markets where new chat limits are enforced.
...
// GetAccountReachoutTimelock gets the current reachout timelock state of the account,
// i.e. whether the account is currently blocked from reaching out to new users and until when.
