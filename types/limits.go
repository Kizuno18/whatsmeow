...
// NewChatMessageCappingOTEStatus is the one-time extension status of a new chat message capping cycle.
...
// NewChatMessageCappingMVStatus is the messaging volume tier status of an account.
...
// NewChatMessageCappingStatus is how close an account is to its new chat message cap.
...
// ReachoutTimelockEnforcementType is the reason an account reachout timelock was applied.
...
// NewChatMessageCappingInfo is the new chat message capping state of an account,
// as returned by Client.GetNewChatMessageCappingInfo.
...
// AccountReachoutTimelock is the reachout timelock state of an account,
// as returned by Client.GetAccountReachoutTimelock.
